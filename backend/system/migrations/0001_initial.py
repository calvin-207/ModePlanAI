    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.ManyToManyField(blank=True, db_constraint=False, to='system.role', verbose_name='关联角色')),
            ],
            options={
                'verbose_name': '消息通知',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('global_user', models.BigIntegerField(default=False, help_text='是否全局用户', verbose_name='是否全局用户')),
                ...
                ('dept', models.ForeignKey(blank=True, db_constraint=False, help_text='关联部门', null=True, on_delete=django.db.models.deletion.PROTECT, to='system.dept', verbose_name='所属部门')),
                ('role', models.ManyToManyField(db_constraint=False, help_text='关联角色', related_name='role_users', to='system.role', verbose_name='关联角色')),
            ],
            options={
                'verbose_name': '用户表',
        ...
        migrations.AddField(
            model_name='role',
            name='creator',
            field=models.ForeignKey(db_constraint=False, help_text='创建人', null=True, on_delete=django.db.models.deletion.SET_NULL, related_query_name='creator_query', to='system.users', verbose_name='创建人'),
        ),
        migrations.CreateModel(
            name='OperationLog',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.CASCADE, to='system.users', verbose_name='关联用户表')),
            ],
            options={
                'verbose_name': '消息用户',
        ...
        migrations.AddField(
            model_name='notification',
            name='users',
            field=models.ManyToManyField(blank=True, related_name='notifications_users', through='system.NotificationUsers', to='system.users', verbose_name='关联用户'),
        ),
        migrations.AddField(
            model_name='menu',
            name='creator',
