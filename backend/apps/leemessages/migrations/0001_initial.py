    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('revuserid', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='messagerevuserid', to='system.users', verbose_name='接收者用户ID')),
                ('senduserid', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='messagesenduserid', to='system.users', verbose_name='发送者用户ID')),
            ],
            options={
                'verbose_name': '用户消息',
